...
export const addUser = createAsyncThunk("user/add", async (user: UserInterface) => {
    const res = await axios.post(`${BaseUrl}/user/add`, {user});
    return res.data;
});

export const editUser = createAsyncThunk("user/edit", async (user: UserInterface) => {
    await axios.post(`${BaseUrl}/user/edit/${user._id}`, user);
    return await user;
});

export const deleteUser = createAsyncThunk("user/delete", async (user: UserInterface) => {
